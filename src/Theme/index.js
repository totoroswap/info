...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#3285FF' : 'black',
  ...
  primary2: darkMode ? '#3680E7' : '#70a4f6',
  primary3: darkMode ? '#4D8FEA' : '#99befd',
  ...
  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#3285FF',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #3285FF 0%, #fff 0%)`,
})
