...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      `https://totoroswap.com/#/` +
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x8f8526dbfd6e38e3d8307702ca8469bae6c56c15' ? 'OKT' : token0Address}/${'OKT'}`
    )
  } else {
    return (
      `https://totoroswap.com/#/` +
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x8f8526dbfd6e38e3d8307702ca8469bae6c56c15' ? 'OKT' : token0Address}/${
        token1Address === '0x8f8526dbfd6e38e3d8307702ca8469bae6c56c15' ? 'OKT' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://totoroswap.com/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://totoroswap.com/#/swap?inputCurrency=${
      token0Address === '0x8f8526dbfd6e38e3d8307702ca8469bae6c56c15' ? 'OKT' : token0Address
    }&outputCurrency=${token1Address === '0x8f8526dbfd6e38e3d8307702ca8469bae6c56c15' ? 'OKT' : token1Address}`
  }
}

export function getMiningPoolLink(token0Address) {
  return `https://totoroswap.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://totoroswap.com/#/uni'
  if (!linkVariable) {
    return baseUniswapUrl
  }

  return `${baseUniswapUrl}/OKT/${linkVariable}`
}
